  ...
  <div className="home-page gs-home">
    ...
    <section id="rutas" className="gs-routes" aria-labelledby="routes-title">
      ...
      <div className="gs-route-grid">
        <Link href="/cursos" className="gs-route-card gs-route-card-blue">
          <div className="gs-route-icon-wrap">
            <RouteIcon type="code" />
          </div>
          <span className="gs-card-kicker">RUTA PRINCIPIANTE</span>
          <h3>Fundamentos de programación</h3>
          <p>Aprende a pensar como programador y crea tus primeras soluciones.</p>
          <span className="gs-route-card-footer">
            4 cursos · 18 horas <ArrowIcon />
          </span>
        </Link>
        <Link href="/cursos" className="gs-route-card gs-route-card-green">
          <div className="gs-route-icon-wrap">
            <RouteIcon type="data" />
          </div>
          <span className="gs-card-kicker">RUTA EN CRECIMIENTO</span>
          <h3>Datos e inteligencia artificial</h3>
          <p>Convierte información en decisiones y experimentos que puedas explicar.</p>
          <span className="gs-route-card-footer">
            6 cursos · 24 horas <ArrowIcon />
          </span>
        </Link>
        <Link href="/cursos" className="gs-route-card gs-route-card-red">
          <div className="gs-route-icon-wrap">
            <RouteIcon type="cloud" />
          </div>
          <span className="gs-card-kicker">RUTA PROFESIONAL</span>
          <h3>Cloud y sistemas modernos</h3>
          <p>Diseña servicios confiables y entiende cómo escalan los productos reales.</p>
          <span className="gs-route-card-footer">
            5 cursos · 21 horas <ArrowIcon />
          </span>
        </Link>
      </div>
    </section>
